"""
K-EDA — Deep Insights Data Profiling
==========================================
...
Sub-modules
-----------
    from k_eda.techniques import us, india, japan, china
    from k_eda.engines import stats_engine, correlation_engine, missing_engine, outlier_engine
"""
...
class ProfileReport:
    ...
    def __init__(self, source, title="K-EDA Report", sections=None,
    ...
    def _generate_sections(self):
        ...
        from .sections import (
            ...
            model_readiness, model_suggestion, feature_engineering, sample,
        )
        ...
        section_generators = {
            ...
            "feature_engineering": lambda: feature_engineering.generate(self.df, self.type_map),
