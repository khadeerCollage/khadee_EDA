...
<head>
    ...
    <meta name="description" content="K-EDA — Deep Insights Data Profiling Report">
    <title>{title} — K-EDA</title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="logo">
                <span class="logo-text">K-EDA</span>
            </div>
        ...
        <div class="sidebar-footer">
            <div class="powered-by">Powered by K-EDA v1.0.0</div>
        </div>
    </nav>
    ...
    <main class="main-content" id="main-content">
        <header class="report-header">
            ...
            <p class="report-subtitle">Deep Insights Data Profiling Report — Powered by K-EDA</p>
            <div class="header-actions">
                <button class="action-btn download-btn" onclick="window.print()" title="Download PDF Report">
        ...
        <footer class="report-footer">
            <p>Generated by <strong>K-EDA</strong> — Deep Insights Data Profiling</p>
        </footer>
    </main>
